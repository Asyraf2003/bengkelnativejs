...
final class CashierHybridPaymentDpPresetFeatureTest extends TestCase
{
    use RefreshDatabase;
    use SeedsMinimalNotePaymentFixture;

    public function test_payment_without_amount_paid_can_pay_only_selected_product_component_total(): void
    {
        $user = $this->seedKasir();
        $this->seedMixedNote();
    ...
    private function seedKasir(): User
    {
        ...
        $user = User::query()->create([
            'name' => 'Kasir DP Preset',
            'email' => 'kasir-dp-preset@example.test',
            'password' => 'password',
        ]);
    ...
    private function seedMixedNote(): void
    {
        ...
        DB::table('products')->insert([
            'id' => 'prod-1',
            'kode_barang' => 'PRD-TEST-003',
            'nama_barang' => 'Sparepart DP',
            'nama_barang_normalized' => 'sparepart dp',
            'merek' => 'TEST',
