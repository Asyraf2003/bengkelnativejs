...
This ADR does not mark any `docs/error_log/*.md` finding as fixed.
...
10. update `docs/error_log` only after proof
...
`docs/error_log/*.md` may be updated only after implementation proof exists.
